...
class KeywordCollectingHandler:
    def __init__(self):
	    self.keywords = []
...
#fi = '/Users/steven/Desktop/test/projects/Air_ORRA_RTSF/artifacts/docker-compose/air-app-service.yml'
#with open(fi, 'r') as f:
#    data = f.read()
#    keywordMapper = KeywordMapper('', '${', '}')
#    keywordMapper.replace(data, KeywordCollectingHandler())
