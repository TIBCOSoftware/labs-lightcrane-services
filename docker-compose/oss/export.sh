...
docker save --output ./archives/labs-lightcrane-deployer-${LABS_AIR_VERSION}.tar public.ecr.aws/tibcolabs/public.ecr.aws/tibcolabs/labs-lightcrane-deployer:${LABS_AIR_VERSION} || exit 1
