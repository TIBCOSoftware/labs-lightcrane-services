...
public class PipeCoupler {
  ...
  public Reply forwardData(Data request) {
	  ...
	  PipeCouplerGrpc.PipeCouplerBlockingStub pipeCouplerServiceBlockingStub = PipeCouplerGrpc.newBlockingStub(managedChannel);
  ...
  /*
  public Reply forwardDatax(Data request) {
	  LOGGER.info("gRPC client sending Data : {}", request);
